...
import JobListing from 'views/dashboard/job-listing';

// import ProfileMangement from 'views/dashboard/Profile-mangement';
// dashboard routing
const DashboardDefault = Loadable(lazy(() => import('views/dashboard/Default')));
const DashboardAnalytics = Loadable(lazy(() => import('views/dashboard/Analytics')));
const ProfileManagement = Loadable(lazy(() => import('views/dashboard/Profile-mangement')));
const PostAJob = Loadable(lazy(() => import('views/dashboard/Post-job')));
